...
You've successfully created a multi-schema website with Magidoc! You are now watching the page of \`${config.appTitle}\`. If you want, feel free to look at the other schemas by clicking on the square icon at the top right of this website.
          `,
        },
      ],
